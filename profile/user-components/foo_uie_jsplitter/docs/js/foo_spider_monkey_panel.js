...
let window = {
    ...
    /**
     * Get panel object by caption (name)
     * @param {string} caption
     * 
     * @return {PanelObject}
     */
    ...
    /**
     * Creates button in (x, y) position of root panel using images as state images and hover_images as hover variants
     * @param {string} x
     * @param {string} y
...
function PanelObject() {
     ...
     * @type {string}
     */
    this.Text = ""; // (string) (read, write)

    /**
     * @type {boolean}
     */
    this.Hidden = false; // (boolean) (read, write)

    /**
     * @type {boolean}
     */
    this.Locked = false; // (boolean) (read, write)

    /**
     * @type {boolean}
     */
    this.ShowCaption = true; // (boolean) (read, write)

    /**
     * @type {boolean}
     */
    this.SupportPseudoTransparency = false; // (boolean) (read, write)

    /**
     * @type {number}
     */
    this.X = 0; // (int) (read, write)

    /**
     * @type {number}
     */
    this.Y = 0; // (int) (read, write)

    /**
     * @type {number}
     */
    this.Width = 320; // (int) (read, write)

    /**
     * @type {number}
     */
    this.Height = 240; // (int) (read, write)

    /**
     * @type {boolean}
     */
    this.TopMost = false; // (boolean) (read, write)

    /**
     * @type {boolean}
     */
    this.EraseBackground = false; // (boolean) (read, write)

    /**
     * @param {boolean=} [show=true]
     */
    this.Show = function (show) { }; // (void) [show]
     ...
     * @param {number} width
     * @param {number} height
     * @param {number=} [repaintParent=false]
     */
    this.Move = function (x, y, width, height, repaintParent) { }; // (void) [, repaintParent]
}
...
function ButtonObject() {
   ...
   /**
     ...
     * @type {number}
     */
    this.Width = 0; // (int) (read, write)

    /**
     * @type {number}
     */
    this.Height = 0; // (int) (read, write)
     ...
     * @type {boolean}
     */
    this.HandOnHover = false; // (boolean) (read, write)

    /**
     * @type {number}
     */
    this.State = 0; // (uint) (read, write)
     ...
     * @param {number} y
     */
    this.Move = function (x, y) { }; // (void)

    /**
     * @param {number} width
     * @param {number} height
     */
    this.Resize = function (width, height) { }; // (void)
}
