...
tooltip.SetFont('Segoe UI', _scale(9));
tooltip.SetMaxWidth(800);
tooltip.SetDelayTime(2, 10000);

let folders = {};
folders.home = fb.ProfilePath + 'themes\\footuner\\js\\samples\\complete\\';
