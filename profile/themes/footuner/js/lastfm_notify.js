...
function on_paint(gr) {
    ...
    gr.GdiDrawText(g_text, g_font, g_hot ? g_textcolour_hl : g_textcolour, 0, 0, ww, wh, DT_CENTER | DT_VCENTER | DT_WORDBREAK | DT_CALCRECT | DT_NOPREFIX);
}
...
function on_notify_data(p, info) {
    if (p == "lastfm") {
        g_text = info;
        window.Repaint();
    }
