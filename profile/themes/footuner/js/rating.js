...
include(fb.ProfilePath + 'themes\\footuner\\js\\samples\\complete\\js\\rating.js');
...
let rating = new _rating(0, 2, 18, _RGB(255, 128, 0)); // x, y, size, colour
...
function on_size() {
	panel.size();
    rating.size = panel.w/5;
    rating.w = rating.size * rating.get_max();
}
