...
let g_backcolour = 0;
let g_hot = false;
let g_color = window.GetColourCUI(ColourTypeCUI.inactive_selection_background);
let ww = 0;
let wh = 0;
...
function on_paint(gr) {
    gr.FillSolidRect(0, 0, ww, wh, g_color );
    gr.GdiDrawText(g_text, g_font, g_hot ? g_textcolour_hl : g_textcolour, 0, 5, ww, wh, DT_VCENTER | DT_NOPREFIX);
}
